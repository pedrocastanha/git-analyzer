...
Be objective and practical."""
    ...
    @staticmethod
    def get(language="pt"):
        return AnalyzerSystemPrompt.EN if language == "en" else AnalyzerSystemPrompt.PT
...
- Use markdown for clear formatting"""
    ...
    def get(language="pt"):
        return (
            GenerateImprovementsSystemPrompt.EN
            if language == "en"
            else GenerateImprovementsSystemPrompt.PT
        )
...
**Return ONLY the commit message, nothing else.**"""
    ...
    def get(language="pt"):
        return (
            GenerateCommitMessageSystemPrompt.EN
            if language == "en"
            else GenerateCommitMessageSystemPrompt.PT
        )
...
❓ Question: [your question here]"""
    ...
    def get(language="pt"):
        return (
            DeepAnalyzeCriticSystemPrompt.EN
            if language == "en"
            else DeepAnalyzeCriticSystemPrompt.PT
        )
...
❓ Question: [new short question]"""
    ...
    def get(language="pt"):
        return (
            DeepAnalyzeConstructiveSystemPrompt.EN
            if language == "en"
            else DeepAnalyzeConstructiveSystemPrompt.PT
        )
...
- If there are no necessary changes, state it clearly in the Executive Summary"""
    ...
    def get(language="pt"):
        return (
            ExecutiveReportSystemPrompt.EN
            if language == "en"
            else ExecutiveReportSystemPrompt.PT
        )
